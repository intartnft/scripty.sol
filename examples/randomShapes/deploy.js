...
async function main() {
	...
	await storeContent(scriptyStorageContract, "drawCircles", "scripts/drawCircles.js");
	await storeContent(scriptyStorageContract, "drawRectangles", "scripts/drawRectangles.js");
	await storeContent(scriptyStorageContract, "drawShapes", "scripts/drawShapes.js");
