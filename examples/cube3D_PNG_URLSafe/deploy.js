...
async function main() {
	console.log("")
	console.log("----------------------------------")
	console.log("Running cube3D_PNG_URLSafe")
	console.log("----------------------------------")
	...
	await storeContent(scriptyStorageContract, "injectPNGScripts-0.0.1", "../../baseScripts/dist/injectPNGScripts-0.0.1.js");
	await storeContent(scriptyStorageContract, "threejs.min.js.png", "../commonScripts/threejs.min.js.png.txt");
	await storeContent(scriptyStorageContract, "cube3D", "scripts/cube3D.js");
