...
async function main() {
	...
	await storeContent(scriptyStorageContract, "gunzipScripts-0.0.1.js", "scripts/gunzipScripts-0.0.1.txt");
	await storeContent(scriptyStorageContract, "es-module-shims.js.gz", "scripts/es-module-shims.js.gz.txt");
	await storeContent(scriptyStorageContract, "threejs.module.js.gz", "scripts/modules/threejs.module.js.gz.txt");
	await storeContent(scriptyStorageContract, "OrbitControls.module.js.gz", "scripts/modules/OrbitControls.module.js.gz.txt");
	await storeContent(scriptyStorageContract, "importHandler", "scripts/importHandler.js");
	await storeContent(scriptyStorageContract, "torus", "scripts/torus.min.js.txt");
